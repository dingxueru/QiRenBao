...
public class PartnerGrowthLogsActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.partner_growth_logs_layout);
        ...
        // adapter 初始化
        growthLogAdapter = new GrowthLogAdapter(PartnerGrowthLogsActivity.this,growthlist);
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Request request, Exception e) {
                        Toast.makeText(PartnerGrowthLogsActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
                    }
...
//                                Toast.makeText(PartnerGrowthLogsActivity.this, "暂无数据", Toast.LENGTH_SHORT).show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(PartnerGrowthLogsActivity.this, "数据解析错误", Toast.LENGTH_SHORT).show();
