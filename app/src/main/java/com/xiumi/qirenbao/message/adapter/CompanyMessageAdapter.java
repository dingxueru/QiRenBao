...
/**
 * Created by qianbailu on 2017/3/24.
 */
...
public class CompanyMessageAdapter extends BaseAdapter {
    ...
    public CompanyMessageAdapter(Context context, ArrayList<MessageBean> messagelist) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.company_message_list_item_layout, parent, false);
