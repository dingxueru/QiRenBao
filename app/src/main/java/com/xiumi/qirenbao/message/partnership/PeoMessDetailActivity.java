package com.xiumi.qirenbao.message.partnership;
...
/**
 * Created by qianbailu on 2017/3/3.
 * 合伙消息详情
 */
public class PeoMessDetailActivity extends AppCompatActivity {
    @Bind(R.id.back)
    TextView back;
    @Bind(R.id.title)
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peo_mess_detail);
    ...
    protected void setStatusBar() {
        // 创建状态栏的管理实例
        SystemBarTintManager tintManager = new SystemBarTintManager(PeoMessDetailActivity.this);
        // 激活状态栏设置
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Request request, Exception e) {
                        Toast.makeText(PeoMessDetailActivity.this,"网络不给力,请重试",Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(PeoMessDetailActivity.this,"数据解析错误",Toast.LENGTH_SHORT).show();
